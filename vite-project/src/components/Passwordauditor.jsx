    ...
    <div className="password-auditor">
      ...
      <div className="auditor-input-section">
        <div className="input-wrapper">
          ...
          <button className="toggle-btn" onClick={() => setShowPassword(!showPassword)}>{showPassword ? '🙈 Hide' : '👁️ Show'}</button>
        </div>
      </div>
      {password && analysis && (
        ...
        <>
          <div className="results-grid">
            <div className="result-card">
              <div className="result-header"><span className="result-icon">{analysis.length >= 12 ? '✅' : analysis.length >= 8 ? '⚠️' : '❌'}</span><h3>Length</h3></div>
            ...
            <div className="result-card">
              <div className="result-header"><span className="result-icon">{analysis.entropy.bits >= 60 ? '✅' : analysis.entropy.bits >= 40 ? '⚠️' : '❌'}</span><h3>Entropy</h3></div>
            ...
            <div className="result-card">
              <div className="result-header"><span className="result-icon">{analysis.variety.types === 4 ? '✅' : analysis.variety.types >= 3 ? '⚠️' : '❌'}</span><h3>Character Variety</h3></div>
            ...
            <div className="result-card">
              <div className="result-header"><span className="result-icon">{analysis.patterns.count === 0 ? '✅' : analysis.patterns.count <= 2 ? '⚠️' : '❌'}</span><h3>Pattern Check</h3></div>
      ...
      <div className="auditor-footer">
        <p className="disclaimer">⚠️ This tool runs entirely in your browser. Your password is never sent to any server.</p>
      </div>
    </div>
  );
}
